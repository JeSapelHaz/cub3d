...
/*   Updated: 2025/05/15 16:20:37 by hbutt            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (*flag == 0 && (
		data->mapinfo.copy_map[y][x] == ' ' ||
		(y == 0 && data->mapinfo.copy_map[y][x] != '1') ||
		(y == data->mapinfo.map_height - 1 && data->mapinfo.copy_map[y][x] != '1') ||
		(x == 0 && data->mapinfo.copy_map[y][x] != '1') ||
		(x == (int)ft_strlen(data->mapinfo.copy_map[y]) - 1 && data->mapinfo.copy_map[y][x] != '1')
	))
	*flag = 1;
